...
def query_agent(
    ...
    try:
        ...
        print("Make sure the service is running: uvicorn POC_agent.service:app --reload --port 8002")
        sys.exit(1)
    ...
    while True:
        try:
            ...
            if user_input.lower() == "clear":
                try:
                    clear_url = agent_url.replace("/agent/query", f"/agent/session/{session_id}/clear")
