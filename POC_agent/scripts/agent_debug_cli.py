...
# Default service URL
DEFAULT_AGENT_URL = "http://localhost:8002/agent/query"
...
class AgentDebugCLI:
    ...
    def query_agent(self, query: str) -> Optional[dict]:
        ...
        try:
            ...
            print(f"Make sure the service is running: uvicorn POC_agent.service:app --reload --port 8002{Colors.RESET}")
            return None
    ...
    def clear_session(self) -> None:
        ...
        try:
            clear_url = self.agent_url.replace("/agent/query", f"/agent/session/{self.session_id}/clear")
