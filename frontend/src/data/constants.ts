// Shared contact and site constants — used by WelcomeScreen, Footer, ConnectModal

export const MY_NAME = 'Raphael San Andres';
export const MY_EMAIL = 'rysanandres@gmail.com';
